...
class HomePage extends hooks.HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Redux Demo App"),
      ),
      body: StoreProvider(
        store: store,
        child: Column(
          children: [
            Row(
              children: [
                allTextButton(store),
                shortTextButton(store),
                longTextButton(store),
              ],
            ),
            TextField(
  ...
  TextButton longTextButton(Store<State> store) {
    return TextButton(
      onPressed: (){
        store.dispatch(
      ...
      child:
      const Text('Long Item'),
    );
  }

  TextButton shortTextButton(Store<State> store) {
    return TextButton(
      onPressed: (){
        store.dispatch(
      ...
      child:
      const Text('Short Item'),
    );
  }

  TextButton allTextButton(Store<State> store) {
    return TextButton(
      onPressed: (){
        store.dispatch(
